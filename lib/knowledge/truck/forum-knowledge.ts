...
export const FORUM_KNOWLEDGE_ENTRIES = [
  ...
  },
  {
    ...
    "topic": "engine_mechanical",
    "summary": "Ford specs 5W-20 and that is what you should use — do NOT switch to 5W-30. The VCT system and cam phasers are calibrated for 5W-20 viscosity. Using thicker oil can cause delayed phaser response and trigger VCT codes. Motorcraft 5W-20 Synthetic Blend (XO-5W20-QSP) is the baseline. For high-mileage trucks, use 5W-20 full synthetic (Pennzoil Platinum 5W-20 or Motorcraft Full Synthetic 5W-20) for better film strength while staying in spec. FL-820-S filter is OEM; Wix 51372XP is the aftermarket consensus pick. Oil change interval: 5K miles max, 3K-4K preferred on high-mileage 3V engines.",
    "consensusFix": "Use Motorcraft 5W-20 Synthetic Blend as baseline. For high-mileage engines (100K+), upgrade to 5W-20 full synthetic (Pennzoil Platinum 5W-20 or Motorcraft Full Synthetic 5W-20) — do NOT switch to 5W-30. Change every 5K miles max, 3K-4K preferred. Filter: Motorcraft FL-820-S or Wix 51372XP.",
    "ownerTips": [
      ...
      "FL-820-S filter has reports of torn pleats — Wix 51372XP is the aftermarket consensus.",
      "Motorcraft FL-820-S is actually made by Purolator.",
    ...
    "recommendedParts": ["Motorcraft XO-5W20-QSP Synthetic Blend", "Pennzoil Platinum 5W-20 Full Synthetic", "Motorcraft FL-820-S filter", "Wix 51372XP filter"],
  ...
  },
  {
    ...
    "recommendedParts": ["Full synthetic 5W-20 oil (NEVER 5W-30)", "Motorcraft FL-820-S or Wix 51372XP filter", "Motorcraft VCT solenoid 8L3Z-6M280-B"],
